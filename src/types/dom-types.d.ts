...
export type AllCSSProperties = Properties &
  PropertiesHyphen &
  SvgProperties &
  SvgPropertiesHyphen;
...
export type CSSProperties = {
  ...
  // [key: `-${string}`]: StateMaybe<AllCSSProperties[K]>
};

export type ElementUnion = ChildDom & (MaybeChildNode | MaybeChildNode[]);

export interface ArrayElement extends Array<ElementUnion> {}
...
export interface EventHandler<T, E = Event> {
  (
    e: E & {
      currentTarget: T;
...
export type EventHandlerUnion<T, E extends Event> =
  | EventHandler<T, E>
...
export type EventHandlerWithOptionsUnion<T, E extends Event> =
  | EventHandler<T, E>
  | EventHandlerWithOptions<T, E>;

const SERIALIZABLE: unique symbol = undefined;
...
export interface CustomElementHTMLAttributes<T> extends HTMLAttributes<T> {
...
export interface PresentationSVGAttributes {
  ...
  "text-decoration"?: StateMaybe<
    "none" | "underline" | "overline" | "line-through" | "blink" | "inherit"
  >;
  "text-rendering"?: StateMaybe<
    | "auto"
    | "optimizeSpeed"
    | "optimizeLegibility"
    | "geometricPrecision"
...
export interface GraphicsElementSVGAttributes<T>
  extends
    ...
    Pick<
      ...
      | "color-rendering"
    > {}
export interface LightSourceElementSVGAttributes<
  T,
...
export interface FeDistantLightSVGAttributes<
  T,
...
export interface FePointLightSVGAttributes<
  T,
> extends LightSourceElementSVGAttributes<T> {
  x?: StateMaybe<number | string>;
  y?: StateMaybe<number | string>;
...
export interface FeSpotLightSVGAttributes<
  T,
> extends LightSourceElementSVGAttributes<T> {
  x?: StateMaybe<number | string>;
  y?: StateMaybe<number | string>;
...
export interface LinearGradientSVGAttributes<
  T,
...
export interface RadialGradientSVGAttributes<
  T,
> extends GradientElementSVGAttributes<T> {
  cx?: StateMaybe<number | string>;
  cy?: StateMaybe<number | string>;
...
export interface MathMLAttributes<T> extends AriaAttributes, DOMAttributes<T> {
  class?: StateMaybe<string>;
  id?: StateMaybe<string>;
  style?: StateMaybe<CSSProperties | string | null>;
  dir?: StateMaybe<"ltr" | "rtl">;
  mathvariant?: StateMaybe<
    | "normal"
    | "bold"
    | "italic"
    | "bold-italic"
...
export interface MathMLAnnotationAttributes<T> extends MathMLAttributes<T> {
  mathbackground?: StateMaybe<string>;
  mathcolor?: StateMaybe<string>;
}

export interface MathMLOperatorAttributes<
  T,
...
export interface MathMLRowAttributes<T> extends MathMLAnnotationAttributes<T> {}

export interface MathMLFracAttributes<T> extends MathMLAnnotationAttributes<T> {
...
export interface MathMLStyleAttributes<
  T,
> extends MathMLAnnotationAttributes<T> {
  mathbackground?: StateMaybe<string>;
  mathcolor?: StateMaybe<string>;
...
export interface MathMLPaddedAttributes<
  T,
> extends MathMLAnnotationAttributes<T> {
  width?: StateMaybe<string>;
  height?: StateMaybe<string>;
...
export interface MathMLFencedAttributes<
  T,
> extends MathMLAnnotationAttributes<T> {
...
export interface MathMLTableAttributes<
  T,
> extends MathMLAnnotationAttributes<T> {
  align?: StateMaybe<
    "axis" | "baseline" | "center" | "top" | "bottom" | string
  >;
...
export interface MathMLTableRowAttributes<
  T,
> extends MathMLAnnotationAttributes<T> {
  rowalign?: StateMaybe<"top" | "bottom" | "center" | "baseline" | "axis">;
  columnalign?: StateMaybe<"left" | "center" | "right">;
...
export interface MathMLTableCellAttributes<
  T,
> extends MathMLAnnotationAttributes<T> {
  rowspan?: StateMaybe<number | string>;
...
export interface MathMLScriptAttributes<
  T,
> extends MathMLAnnotationAttributes<T> {
...
export interface MathMLMultiscriptsAttributes<
  T,
> extends MathMLAnnotationAttributes<T> {
  subscriptshift?: StateMaybe<string>;
  superscriptshift?: StateMaybe<string>;
...
export interface MathMLAnnotationElementAttributes<
  T,
> extends MathMLAnnotationAttributes<T> {
  encoding?: StateMaybe<string>;
  src?: StateMaybe<string>;
...
export interface DOMElementsMap
  extends
    HTMLElementTags,
