...
*/
import { Element as Element$1 } from "mini-van-plate/van-plate";
...
declare const Router: (initialProps?: Record<string, unknown>) => Element | Promise<Element>;
//#endregion
 ...
 */
declare function Route(routeProps: RouteProps): void;
//#endregion
...
declare const A: ({
  ...
  children,
  ...rest
}?: AnchorProps, ...otherChildren: MaybeChildNode[]) => OutputElement<"a">;
//#endregion
 ...
 * @param url
 */
declare function fixRouteUrl(url?: string): string;
declare const routerState: {
  pathname: _$vanjs_core0.State<string>;
  searchParams: _$vanjs_core0.State<URLSearchParams>;
  params: _$vanjs_core0.State<Record<string, string>>;
};
/**
 ...
 */
declare function setRouterState(path: string, search?: string, params?: Record<string, string>): void;
//#endregion
 ...
 * @param importFn
 */
declare function lazy(importFn: ImportFn): () => Promise<ComponentModule>;
//#endregion
//#region src/router/helpers.d.ts
declare function isCurrentPage(pageName: string): boolean;
declare const isCurrentLocation: (pageName: string) => boolean;
declare function isLazyComponent(component: unknown): component is () => Promise<unknown>;
/**
 ...
 */
declare function getCached(key: ImportFn): ComponentModule | undefined;
/**
 * Cache a route.
 * @param key the cache route key
 * @param value the cache route
 */
declare function cache(key: ImportFn, value: ComponentModule): void;
//#endregion
 ...
 * @param children
 */
declare const unwrap: (source: unknown, ...children: MaybeChildNode[]) => {
  children: MaybeChildNode[];
};
//#endregion
//#region src/router/extractParams.d.ts
declare function extractParams(pattern: string, path: string): Record<string, string> | null;
//#endregion
export { A, ComponentFn, ComponentModule, DynamicModule, FileRouteConfig, ImportFn, LazyComponent, Route, RouteEntry, RouteProps, Router, cache, executeLifecycle, extractParams, fixRouteUrl, getCached, isCurrentLocation, isCurrentPage, isLazyComponent, lazy, navigate, routerState, routes, setRouterState, unwrap };
