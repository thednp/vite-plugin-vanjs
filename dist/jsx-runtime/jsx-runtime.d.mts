/*!
* vite-plugin-vanjs JSX Runtime v0.2.0 (https://github.com/thednp/vite-plugin-vanjs#README)
...
declare function jsx<K extends TagNames = "main">(jsxTag: TagNames | Component<K>, {
  children,
  ref,
  ...rest
}: ComponentProps<K>): OutputElement<K> | null;
//#endregion
