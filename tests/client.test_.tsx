...
import { type ChildDom, type State } from 'vanjs-core'
import van from '../src/setup/van'
import { expect, test, describe } from "vitest";
import { A } from "../src/router"
// import type * as React from "../src/jsx"
// import * as React from "@vanjs/jsx"
...
describe(`Test client-side JSX`, () => {
  test(`Test regular tags`, async () => {
    ...
    const spanStyle = { margin: '0', padding: spanPadding };
    const divData = () => 'yes';
    const myButton = (
      <button
        id="my-button"
